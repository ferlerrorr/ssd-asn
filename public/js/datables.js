 ...
 */ !(function (t) {
        ...
        p = function (e, n) {
            ...
            (n = e),
                ...
                (this.fnFilter = function (t, e, n, r, o, i) {
                    var l = this.api(!0);
                    (null === e || e === a ? l : l.column(e)).search(
                        t,
                        n,
                        r,
                        i
                ...
                (this.fnUpdate = function (t, e, n, r, o) {
                    var i = this.api(!0);
                    return (
                        (n === a || null === n ? i.row(e) : i.cell(e, n)).data(
                            t
                        ),
            ...
            return (
                this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase())
                        ...
                        for (
                            var d = p.settings, r = 0, h = d.length;
                            r < h;
                            r++
                        ) {
                            var g = d[r];
                        ...
                        (null !== s && "" !== s) ||
                            ((s = "DataTables_Table_" + p.ext._unique++),
                            (this.id = s));
                        var m,
                            S,
                        ...
                        if (
                            (0 !== s.length &&
                                (tf(v.aoHeader, s[0]), (T = td(v))),
                            null === e.aoColumns)
                        )
                            for (m = [], r = 0, h = T.length; r < h; r++)
                                m.push(null);
                        else m = e.aoColumns;
                        for (r = 0, h = m.length; r < h; r++)
                            H(v, T ? T[r] : null);
                            ...
                            s = function () {
                                ...
                                if (
                                    ...
                                    0 === i.children().length
                                        ...
                                        : 0 < i.length &&
                                          ((v.nTFoot = i[0]),
                                          tf(v.aoFooter, v.nTFoot)),
                                    e.aaData)
                                )
                                    for (r = 0; r < e.aaData.length; r++)
                                        V(v, e.aaData[r]);
                                else
    ...
    function _(e) {
        ...
        t.each(e, function (t, o) {
            (n = t.match(/^([^A-Z]+?)([A-Z])/)) &&
                ...
                ((r[(a = t.replace(n[0], n[2].toLowerCase()))] = t),
                "o" === n[1]) &&
                _(e[t]);
        }),
            (e._hungarianMap = r);
                ...
                for (
                    ...
                    if ("number" == typeof d[h] && 0 <= d[h]) {
                        ...
                        for (s = 0, u = c.length; s < u; s++)
                            ("_all" == d[h] || t(c[s].nTh).hasClass(d[h])) &&
                                o(s, f);
        }
    ...
    function ta(t, e, n, r) {
        ...
        return (
            e && (e = e.getAttribute("id")) && K(t.rowId)(r, e),
            { data: r, cells: c }
        );
    }
    function tr(e, a, r, o) {
    ...
    function ti(e) {
        ...
        if (
            ...
            for (var c = e.aoFooter[0], f = 0, d = c.length; f < d; f++)
                (r = u[f])
                    ? ((r.nTf = c[f].cell),
                      r.sClass && t(r.nTf).addClass(r.sClass))
                    : t7(e, 0, "Incorrect column count", 18);
    }
    function tl(e, n, r) {
        var o,
    ...
    function ts(e, n) {
        ...
        if (-1 !== t.inArray(!1, r)) tW(e, !1);
            ...
            if (0 !== f.length)
                for (
                    var h = c ? e.aoData.length : d, p = c ? 0 : r;
                    p < h;
                    p++
                ) {
                    var g,
                    ...
                    0 !== s &&
                        ...
                        (t(m).removeClass($._sRowStripe).addClass(g),
                        ($._sRowStripe = g)),
        ...
        for (o = 0, s = h.length; o < s; o++)
            for (r = (a = h[o]).firstChild; r; ) {
                if (
                    ...
                    for (
                        c =
                            (c = +r.getAttribute("colspan")) && 0 != c && 1 != c
                                ? c
                                : 1,
                            f =
                                (f = +r.getAttribute("rowspan")) &&
                                0 != f &&
                                1 != f
                                    ? f
                                    : 1,
                ...
                for (a = [], e = 0, n = i.length; e < n; e++)
                    i[e].bSearchable
                        ...
                        r.indexOf &&
                            -1 !== r.indexOf("&") &&
                            ((tT.innerHTML = r),
                            (r = tw ? tT.textContent : tT.innerText)),
        ...
        for (
            ...
            for (i = (l = d[(c = b[r][(o = 0)])].aDataSort).length; o < i; o++)
                (u = d[(s = l[o])].sType || "string"),
                    b[r]._idx === a &&
                        (b[r]._idx = t.inArray(b[r][1], d[s].asSorting)),
                    f.push({
                        src: c,
                        col: s,
                        dir: b[r][1],
        ...
        "number" == typeof u[0] && (u = e.aaSorting = [u]),
            r && e.oFeatures.bSortMulti
                ? -1 !== (s = t.inArray(n, C(u, "0")))
                    ? null ===
                      (l = null === (l = i(u[s], !0)) && 1 === u.length ? 0 : l)
                        ? u.splice(s, 1)
    ...
    function tZ(e) {
        ...
        if (s.bSort && s.bSortClasses) {
            for (n = 0, a = o.length; n < a; n++)
                (r = o[n].src),
                    t(C(e.aoData, "anCells", r)).removeClass(
                        i + (n < 2 ? n + 1 : 3)
                    );
            for (n = 0, a = l.length; n < a; n++)
                (r = l[n].src),
                    t(C(e.aoData, "anCells", r)).addClass(
                        i + (n < 2 ? n + 1 : 3)
                    );
        }
        e.aLastSort = l;
                ...
                if (
                    ...
                    for (o = 0, i = n.columns.length; o < i; o++) {
                        ...
                        c.visible !== a &&
                            ...
                            c.search !== a &&
                                t.extend(e.aoPreSearchCols[o], tI(c.search));
                    }
                    s && s.columns.adjust();
                }
                (e._bLoadingState = !1),
                    ea(e, "aoStateLoaded", "stateLoaded", [e, n]);
            }
        ...
        n &&
            ...
            "ssp" == ei(t)
                ...
                : (tW(t, !0),
                  ...
                  th(t, [], function (n) {
                      tt(t);
                      for (var a = t$(t, n), r = 0, o = a.length; r < o; r++)
                          V(t, a[r]);
                      tu(t, e), tW(t, !1);
                  }));
    }
    function es(t, e, n, r, o) {
        for (
            var i,
                ...
                h = 0,
                p = (e =
                    e && "string" != d && "function" != d && e.length !== a
                        ? e
                        : [e]).length;
            h < p;
            h++
    ...
    var eh = [],
        ...
        eg = function (e, n) {
            ...
            var r = [];
            if (Array.isArray(e))
                for (var o = 0, i = e.length; o < i; o++) a(e[o]);
            else a(e);
            (this.context = w(r)),
                n && t.merge(this, n),
            ...
            t.extend(eg.prototype, {
                ...
                iterator: function (t, e, n, r) {
                    ...
                    for (
                        ...
                        var b = new eg(p[i]);
                        if ("table" === e)
                            (o = n.call(b, p[i], i)) !== a && h.push(o);
                        else if ("columns" === e || "rows" === e)
                            (o = n.call(b, p[i], this[i], i)) !== a &&
                                h.push(o);
                        else if (
                            "column" === e ||
                            "column-rows" === e ||
                            ...
                            (function e(n, a) {
                                ...
                                if (Array.isArray(n) || n instanceof t)
                                    ...
                                    "tr" === n.nodeName.toLowerCase()
                                        ? s.push(n)
                                        : ((o =
                                              t("<tr><td></td></tr>").addClass(
                                                  a
                                              )),
                                          (t("td", o)
                                              .addClass(a)
                                              .html(n)[0].colSpan = M(r)),
                                          s.push(o[0]));
                            })(i, (l = n)),
        ...
        t.each(
            ...
            function (t, n) {
                (f.type.order[t + e + "-pre"] = n),
                    t.match(/^html\-/) &&
                        (f.type.search[t + e] = f.type.search.html);
            }
        );
    }
    function ew(t) {
    ...
    t.extend(ey, {
        ...
        t.extend(p.ext.type.detect, [
            ...
            function (t, e) {
                return o(t, (e = e.oLanguage.sDecimal), !0)
                    ? "num-fmt" + e
                    : null;
            },
            function (t, e) {
            ...
            function (t, e) {
                return i(t, (e = e.oLanguage.sDecimal), !0)
                    ? "html-num-fmt" + e
                    : null;
            },
            function (t, e) {
    ...
    if (e.Intl !== a)
        try {
            for (
                var eR = new Intl.NumberFormat().formatToParts(100000.1),
                    eP = 0;
                eP < eR.length;
                eP++
            )
                        ...
                        display: function (a) {
                            ...
                            return isNaN(l)
                                ...
                                : ((l = parseInt(
                                  ...
                                  (a = n
                                      ? e + (a - l).toFixed(n).substring(2)
                                      : ""),
                                  (i =
                                      0 === l && 0 === parseFloat(a) ? "" : i) +
                                      (r || "") +
                                      l
                                          .toString()
                                          .replace(/\B(?=(\d{3})+(?!\d))/g, t) +
